...
public class DashboardFragmentRegistry {
        ...
        /**
         * Map from parent fragment to category key. The parent fragment hosts child
         * with category_key.
         */
        public static final Map<String, String> PARENT_TO_CATEGORY_KEY_MAP;

        /**
         * Map from category_key to parent. This is a helper to look up which fragment
         * hosts the category_key.
         */
        ...
        static {
                ...
                PARENT_TO_CATEGORY_KEY_MAP.put(DesktopDashboardFragment.class.getName(),
                                CategoryKey.CATEGORY_PIONUX_DESKTOP);
